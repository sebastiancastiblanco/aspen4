		...
		if ($dp.find("div#ui-timepicker-div-"+ dp_id).length === 0 && o.showTimepicker) {
			var noDisplay = ' style="display:none;"',
				html =	'<div class="ui-timepicker-div " id="ui-timepicker-div-' + dp_id + '"><dl>' +
						'<dt class="ui_tpicker_time_label tituloCampoCalendar" id="ui_tpicker_time_label_' + dp_id + '"' +
						((o.showTime) ? '' : noDisplay) + '>' + o.timeText + '</dt>' +
						'<dd class="ui_tpicker_time tituloCampoCalendarValor" id="ui_tpicker_time_' + dp_id + '"' +
						((o.showTime) ? '' : noDisplay) + '></dd>' +
						'<dt class="ui_tpicker_hour_label tituloCampoCalendar" id="ui_tpicker_hour_label_' + dp_id + '"' +
			...
			html += '<dt class="ui_tpicker_minute_label tituloCampoCalendar" id="ui_tpicker_minute_label_' + dp_id + '"' +
