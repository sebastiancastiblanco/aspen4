...
class EstadosControllerTest < ActionController::TestCase
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post :create, estado: { conclusion: @estado.conclusion, fecha: @estado.fecha, resumen: @estado.resumen, tipo: @estado.tipo }
    end
  ...
  test "should update estado" do
    put :update, id: @estado, estado: { conclusion: @estado.conclusion, fecha: @estado.fecha, resumen: @estado.resumen, tipo: @estado.tipo }
    assert_redirected_to estado_path(assigns(:estado))
  end
